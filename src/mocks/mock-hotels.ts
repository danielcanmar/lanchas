export let HOTELS = [
  {
    id: 1,
    name: "Bacalar Pueblo Magico",
    rating: 5,
    price: 150,
    horarios: "9: 00 A.M - 12: 00 P.M 12: 00 - 3: 00 P.M",
    lugar:false,
    sale_price: 120,    
    location: {
      lat: -22.906847,
    ...
    features: "9:00 A.M - 12:00 P.M 12:00 - 3:00 P.M. with A lot of restaurants and businnes conference room, this hotel has a full-service spa and an outdoor pool. Free WiFi in public areas and free valet parking are also provided. Other amenities include a nightclub, a health club, and a bar/lounge. ",
